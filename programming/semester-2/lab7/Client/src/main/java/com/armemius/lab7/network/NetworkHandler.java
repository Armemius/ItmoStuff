...
public class NetworkHandler {
    ...
    private static volatile String login = null;
    ...
    public static C2SPayload genPayload(PayloadTypes type, TaskContextData data) {
        return new C2SPayload(type, login, password, data);
    }

    public static C2SPayload genPayload(PayloadTypes type, String login, String password, TaskContextData data) {
        return new C2SPayload(type, login, password, data);
    }
    ...
    public static void setPassword(String password) {
        NetworkHandler.password = password;
    }
    ...
    private static void processIncomingPayload(S2CPayload payload) {
        ...
        switch (status) {
            ...
            case AUTH_REQUIRED -> outputHandler.println("Auth required");
