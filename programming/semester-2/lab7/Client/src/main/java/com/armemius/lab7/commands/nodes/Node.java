package com.armemius.lab7.commands.nodes;
...
public abstract class Node {
    ...
    public boolean run(CommandContext context) {
        ...
        var requireAuth = taskClass.getAnnotation(RequireAuth.class);
        if (requireAuth != null && NetworkHandler.getLogin() == null) {
            throw new CommandArgumentException("This command requires authentication");
        }
